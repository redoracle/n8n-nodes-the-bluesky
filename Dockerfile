...
if [ -L /home/node/.n8n/node_modules/n8n-nodes-the-bluesky ]; then
	echo "Removing stale symlink at /home/node/.n8n/node_modules/n8n-nodes-the-bluesky" && rm -f /home/node/.n8n/node_modules/n8n-nodes-the-bluesky || true
fi
mkdir -p /home/node/.n8n/node_modules
if [ ! -d /home/node/.n8n/node_modules/n8n-nodes-the-bluesky ]; then
	if [ -d /opt/plugins/node_modules/n8n-nodes-the-bluesky ]; then
		echo "Copying plugin from /opt/plugins into /home/node/.n8n/node_modules..." && cp -a /opt/plugins/node_modules/n8n-nodes-the-bluesky /home/node/.n8n/node_modules/ && chown -R node:node /home/node/.n8n/node_modules/n8n-nodes-the-bluesky || true
	else
		echo "No plugin found in /opt/plugins to copy into volume."
	fi
else
	echo "Per-user package already present in volume: /home/node/.n8n/node_modules/n8n-nodes-the-bluesky"
fi
# Ensure ownership
