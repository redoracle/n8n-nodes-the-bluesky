...
Troubleshooting: `TypeError: Class extends value undefined` or similar
...
rsync -a --delete dist/ ~/.n8n/custom/n8n-nodes-the-bluesky/
...
docker compose -f docker-compose.dev.plugin.yml exec n8n sh -lc "mkdir -p /home/node/.n8n/custom && cd /tmp/plugin/node_modules && tar -cf - n8n-nodes-the-bluesky | tar --no-same-owner -x -C /home/node/.n8n/custom && chown -R node:node /home/node/.n8n/custom/n8n-nodes-the-bluesky"
...
```bash
docker compose -f docker-compose.dev.plugin.yml exec n8n node -e "try{require('/home/node/.n8n/custom/n8n-nodes-the-bluesky/dist/nodes/Bluesky/Bluesky.node.js'); console.log('require OK')}catch(e){console.error('require ERR', e && e.stack? e.stack : e)}"
```
